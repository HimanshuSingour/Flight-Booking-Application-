...
public class PassengerDTO {
	...
	public PassengerDTO(int passenger_id, String passenger_age, String passenger_gender, String passenger_name,
			int passenger_pnr) {
		super();
	...
	public String toString() {
		return "PassengerDTO [passenger_id=" + passenger_id + ", passenger_age=" + passenger_age + ", passenger_gender="
				+ passenger_gender + ", passenger_name=" + passenger_name + ", passenger_pnr=" + passenger_pnr + "]";
	}
